...
const AddDataSourcePage: React.FC = () => {
  ...
  //  const [state, send] = useDataSources();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    send({ type: 'ADD_DATA_SOURCE', data: formData });
  };
    ...
    <AdminLayout>
      <div className='p-4'>
        ...
        <div className='flex items-center mb-6'>
          <Link href={`/data-sources`} className='mr-4'>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div className='flex justify-end space-x-3 pt-6 border-t border-border'>
              ...
              <button
                ...
                {state.matches('addingDataSource') ? 'Adding...' : 'Create Data Source'}
              </button>
            </div>
          </form>
        </div>
